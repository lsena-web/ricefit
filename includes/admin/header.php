...
<head>
    ...
    <!-- JQVMap -->
    <link rel="stylesheet" href="../b4/plugins/jqvmap/jqvmap.min.css">
    <!-- Theme style -->
    ...
    <!-- Daterange picker -->
    <link rel="stylesheet" href="../b4/plugins/daterangepicker/daterangepicker.css">
    <!-- summernote -->
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="../b4/dist/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
        </div>
