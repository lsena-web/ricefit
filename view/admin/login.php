...
<head>
    ...
    <link rel="stylesheet" href="../estilosAdmin/css/styleLogin.css">
</head>
        ...
        <div class="login-box">
            ...
            <div class="card card-outline card-success">
                <div class="card-header text-center">
                    ...
                    <div class="text-center text-success">Área administrativa.</div>
                </div>
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-end">
                        <div class="mt-2 mx-1">
                            <p>
                                <a href="forgot.php">Recuperar Senha</a>
                            </p>
                        </div>
                    </div>
            ...
            <div class="text-center mt-3">
                <a href="../index.php" class="btn btn-light text-success text-bold">Área do Aluno</a>
            </div>
        </div>
    </div>
    <!-- /.login-box -->
