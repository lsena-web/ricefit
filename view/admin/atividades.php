...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><b>Atividades</b><i class="nav-icon fas fa-clipboard-list text-success ml-2"></i></h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col-auto ml-auto">
                            <div><i class="nav-icon fas fa-clipboard-list text-xl text-bold text-success"></i></div>
                        </div>
                    </div>
                </div>
                <div class="card-body">
