...
$infoInputs = $con->read('idAluno = ' . $_SESSION['cliente']['id'], 'id DESC', 1);

// BUSCANDO TODOS OS IMCS E SUAS DATAS DE AVALIAÇÃO
$imc = $con->read('idAluno = ' . $_SESSION['cliente']['id'], 'id DESC', 12, 'imc');
$label = $con->read('idAluno = ' . $_SESSION['cliente']['id'], 'id DESC', 12, 'dataAvaliacao');
...
include __DIR__ . '/../view/alunos/geral.php';
